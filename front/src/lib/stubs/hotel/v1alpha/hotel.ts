...
/**
 * @generated from protobuf message hotel.v1alpha.UsageRequest
 */
export interface UsageRequest {
    ...
    hotelName: string;
    /**
     * @generated from protobuf field: hotel.v1alpha.EventType event_type = 3;
     */
    eventType: EventType;
}
/**
 * @generated from protobuf message hotel.v1alpha.UsageResponse
 */
...
/**
 * @generated from protobuf message hotel.v1alpha.StreamHotelsRequest
 */
export interface StreamHotelsRequest {
}
/**
 * @generated from protobuf message hotel.v1alpha.StreamHotelsResponse
 */
...
/**
 * @generated from protobuf message hotel.v1alpha.ListHotelsRequest
 */
...
/**
 * @generated from protobuf message hotel.v1alpha.ListHotelsResponse
 */
...
/**
 * @generated from protobuf message hotel.v1alpha.GetHotelRequest
 */
...
/**
 * @generated from protobuf message hotel.v1alpha.CreateHotelRequest
 */
export interface CreateHotelRequest {
     ...
     *
     * @generated from protobuf field: hotel.v1alpha.Hotel hotel = 3;
     */
    hotel?: Hotel;
}
/**
 * @generated from protobuf message hotel.v1alpha.UpdateHotelRequest
 */
...
/**
 * @generated from protobuf message hotel.v1alpha.DeleteHotelRequest
 */
...
/**
 * @generated from protobuf enum hotel.v1alpha.EventType
 */
...
class UsageRequest$Type extends MessageType<UsageRequest> {
    constructor() {
        super("hotel.v1alpha.UsageRequest", [
            { no: 1, name: "username", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "hotel_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "event_type", kind: "enum", T: () => ["hotel.v1alpha.EventType", EventType, "EVENT_TYPE_"] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string hotel_name */ 2:
                    ...
                    break;
                case /* hotel.v1alpha.EventType event_type */ 3:
    ...
    internalBinaryWrite(message: UsageRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* hotel.v1alpha.EventType event_type = 3; */
...
/**
 * @generated MessageType for protobuf message hotel.v1alpha.StreamHotelsRequest
 */
...
class StreamHotelsResponse$Type extends MessageType<StreamHotelsResponse> {
    constructor() {
        super("hotel.v1alpha.StreamHotelsResponse", [
...
/**
 * @generated MessageType for protobuf message hotel.v1alpha.StreamHotelsResponse
 */
...
class ListHotelsRequest$Type extends MessageType<ListHotelsRequest> {
    constructor() {
        super("hotel.v1alpha.ListHotelsRequest", [
...
/**
 * @generated MessageType for protobuf message hotel.v1alpha.ListHotelsRequest
 */
...
class ListHotelsResponse$Type extends MessageType<ListHotelsResponse> {
    constructor() {
        super("hotel.v1alpha.ListHotelsResponse", [
...
/**
 * @generated MessageType for protobuf message hotel.v1alpha.ListHotelsResponse
 */
...
class GetHotelRequest$Type extends MessageType<GetHotelRequest> {
    constructor() {
        super("hotel.v1alpha.GetHotelRequest", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message hotel.v1alpha.GetHotelRequest
 */
...
class CreateHotelRequest$Type extends MessageType<CreateHotelRequest> {
    constructor() {
        super("hotel.v1alpha.CreateHotelRequest", [
            { no: 1, name: "parent", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string hotel_id */ 2:
                    ...
                    break;
                case /* hotel.v1alpha.Hotel hotel */ 3:
                    message.hotel = Hotel.internalBinaryRead(reader, reader.uint32(), options, message.hotel);
                    break;
                default:
                    let u = options.readUnknownField;
...
/**
 * @generated MessageType for protobuf message hotel.v1alpha.CreateHotelRequest
 */
...
class UpdateHotelRequest$Type extends MessageType<UpdateHotelRequest> {
    constructor() {
        super("hotel.v1alpha.UpdateHotelRequest", [
            { no: 1, name: "hotel", kind: "message", T: () => Hotel }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message hotel.v1alpha.UpdateHotelRequest
 */
...
class DeleteHotelRequest$Type extends MessageType<DeleteHotelRequest> {
    constructor() {
        super("hotel.v1alpha.DeleteHotelRequest", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message hotel.v1alpha.DeleteHotelRequest
 */
export const DeleteHotelRequest = new DeleteHotelRequest$Type();
/**
 * @generated ServiceType for protobuf service hotel.v1alpha.HotelService
 */
export const HotelService = new ServiceType("hotel.v1alpha.HotelService", [
    { name: "ListHotels", options: {}, I: ListHotelsRequest, O: ListHotelsResponse },
    { name: "GetHotel", options: {}, I: GetHotelRequest, O: Hotel },
    { name: "CreateHotel", options: {}, I: CreateHotelRequest, O: Hotel },
    { name: "UpdateHotel", options: {}, I: UpdateHotelRequest, O: Hotel },
    { name: "DeleteHotel", options: {}, I: DeleteHotelRequest, O: Hotel },
    { name: "StreamHotels", serverStreaming: true, options: {}, I: StreamHotelsRequest, O: StreamHotelsResponse }
]);
/**
 * @generated ServiceType for protobuf service hotel.v1alpha.UsageService
 */
export const UsageService = new ServiceType("hotel.v1alpha.UsageService", [
